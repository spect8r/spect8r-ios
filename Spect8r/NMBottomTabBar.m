...
-(void)configureTabAtIndex : (NSInteger)index andTitleOrientation : (NMTitleOrientation)titleOrientation withUnselectedBackgroundImage : (UIImage *)backImage selectedIconImage : (UIImage *)selectedIconImage iconImage : (UIImage *)iconImage andText : (NSString *)text andTextFont:(UIFont *)font andFontColour:(UIColor *)color{
    
    UIButton *button = (UIButton *)[self viewWithTag:index +1];
    [button setBackgroundImage:backImage forState:UIControlStateNormal];
    [button setImage:selectedIconImage forState:UIControlStateSelected];
