...
#define MitimLoadingAlertInstancetype instancetype
#else
#define MitimLoadingAlertInstancetype id
#endif

@class MitimLoadingAlertView;
@protocol MitimLoadingAlertViewDelegate;
...
typedef NS_ENUM(NSInteger, MitimLoadingAlertViewAnimation) {
    /** Default animation. */
    MitimLoadingAlertViewAnimationDefault = 0,
    
    /** The alert view slide to top side. */
    MitimLoadingAlertViewAnimationSlideTop,
    
    /** The alert view slide to bottom side. */
    MitimLoadingAlertViewAnimationSlideBottom,
    
    /** The alert view slide to left side. */
    MitimLoadingAlertViewAnimationSlideLeft,
    
    /** The alert view slide to right side. */
    MitimLoadingAlertViewAnimationSlideRight,
};

/// Custom alert view solved the ios UIAlertView can't addSubview problem at iOS7.
@interface MitimLoadingAlertView : UIView
...
/** Default is MitimLoadingAlertViewAnimationDefault.
 *
 * @brief The dismiss animetion, when button clicked.
 *
 * @see MitimLoadingAlertViewAnimation
 */
@property (nonatomic, assign) MitimLoadingAlertViewAnimation dismissAnimationWhenButtonClicked;
 ...
 * Only can get it when MitimLoadingAlertViewMode is MitimLoadingAlertViewModeTextInput.
 *
 * @brief The UITextField appears MitimLoadingAlertViewModeTextInput.
 */
...
/** See the descriptions of the constants of the MitimLoadingAlertViewAnimation type for more information.
...
@protocol MitimLoadingAlertViewDelegate  <NSObject>
 ...
 */
- (void)alertView:(MitimLoadingAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex;
 ...
 */
- (void)alertViewWillDismiss:(MitimLoadingAlertView *)alertView;
 ...
 */
- (void)alertViewDidDismiss:(MitimLoadingAlertView *)alertView;

/** @brief Sent to the delegate when textField text did change.
 *
 * @param alertView The alert view containing textField.
 */
- (void)alertViewTextDidChanged:(MitimLoadingAlertView *)alertView;
- (void) close;
